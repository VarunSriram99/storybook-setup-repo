      ...
      <AnimatePresence>
        {isOpen && (
          <Backdrop
            ...
            className={classnames("cs-ui-modal__backdrop", backdropClassName)}
          >
            <motion.div
              role="dialog"
              aria-modal={true}
              ...
              ref={modalWrapper}
              key="modal-wrapper"
              className={classnames("cs-ui-modal__wrapper", {
                "cs-ui-modal__wrapper--xs": size === SIZES.xs,
                "cs-ui-modal__wrapper--sm": size === SIZES.sm,
                "cs-ui-modal__wrapper--md": size === SIZES.md,
                [className]: className,
              })}
              {...otherProps}
            >
