  ...
  return (
    <div className="cs-ui-pageloader__wrapper" {...otherProps}>
      <div className="cs-ui-pageloader">
        <div className="cs-ui-page-loader__content relative mb-4 flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-md p-2">
          <motion.div
            variants={ROTATE_VARIANTS}
            animate="rotate"
            initial="initial"
            className="cs-ui-bg-gray-800 absolute top-0 left-0 h-14 w-14 rounded-md"
          ...
          >
            <path
              className="cs-ui-page-loader__svg-placeholder-path"
              stroke="#1b1f23"
              strokeLinecap="round"
              strokeWidth="2.5"
            ...
            ></path>
            <motion.path
              className="cs-ui-page-loader__svg"
              stroke="#fff"
              strokeLinecap="round"
              strokeWidth="2.5"
              d="M10.44 18.069l-4.1 4.381c-1 1-4.2 1.393-4.3-2-.09-3.104 0-8.372 0-10.636 0-3.13 2.46-2.715 3.8-1.414 2 1.94 6.617 6.554 8.95 8.818 1.063 1.031 3.65 1.345 3.65-1.76V4.785c0-2.171-2.14-3.542-3.8-2.335-2.117 1.541-3.766 3.951-4.6 4.76"
