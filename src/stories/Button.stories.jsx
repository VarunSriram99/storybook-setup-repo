...
export const AllVariants = () => (
  <div className="m-1 overflow-auto">
    ...
    <div className="w-full flex gap-4 justify-start pr-16">
      <div className="border border-dashed border-blue-500">
        <div className="flex flex-col gap-4 items-center p-8">
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Primary with icon on left(loading)
          </Typography>
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Primary with icon on right(loading)
          </Typography>
      ...
      <div className="border border-dashed border-blue-500">
        <div className="flex flex-col gap-4 items-center p-8">
          <Typography style="h3" type="semibold" className="whitespace-nowrap">
            {" "}
            Secondary Variants{" "}
          </Typography>
          <Typography
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Secondary with icon on left(loading)
          </Typography>
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Secondary with icon on right(loading)
          </Typography>
          <Button
            label="Secondary"
            loading
      ...
      <div className="border border-dashed border-blue-500">
        <div className="flex flex-col gap-4 items-center p-8">
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Text with icon on left(loading)
          </Typography>
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Text with icon on right(loading)
          </Typography>
      ...
      <div className="border border-dashed border-blue-500 mr-8">
        <div className="flex flex-col gap-4 items-center p-8">
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Danger with icon on left(loading)
          </Typography>
          ...
          <Typography
            ...
            className="whitespace-nowrap"
          >
            Danger with icon on right(loading)
          </Typography>
          <Button label="Danger" loading iconPosition="right" style="danger" />
        </div>
      </div>
    </div>
    <Typography style="h3" type="semibold" className="mt-8">
      SIZES
    </Typography>
    <div className="w-full flex gap-4 justify-start pr-16">
      <div className="border border-dashed border-blue-500">
      ...
      <div className="border border-dashed border-blue-500">
        <div className="flex flex-col gap-4 items-center p-8">
          <Typography style="h3" type="semibold" className="mb-1">
            Medium
          </Typography>
          <div className="flex gap-4">
      ...
      <div className="border border-dashed border-blue-500">
        <div className="flex flex-col gap-4 items-center p-8">
          <Typography style="h3" type="semibold" className="mb-2">
            Small
          </Typography>
          <div className="flex gap-4">
